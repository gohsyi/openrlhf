...
mkdir -p $NAS/checkpoint/gemma-2-2b-iter-dpo
GENERATE_OUTPUT=$NAS/checkpoint/gemma-2-2b-iter-dpo/generate.jsonl
RM_OUTPUT=$NAS/checkpoint/gemma-2-2b-iter-dpo/rm.jsonl
MODEL_OUTPUT_PATH=$NAS/checkpoint/gemma-2-2b-iter-dpo/checkpoint
ITER_LOG_PATH=null

TRAINING_ITERS=6
ROLLOUT_BATCH_SIZE=8192

POLICY_MODEL_PATH=$NAS/models/gemma-2-2b-sft
