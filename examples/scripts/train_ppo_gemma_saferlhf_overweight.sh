...
deepspeed --master_port $PORT1 --module openrlhf.cli.train_ppo \
    --prompt_data $NAS/data/saferlhf-2k-underweight-gemma \
    --prompt_split train \
    --eval_split test \
    --input_key prompt \
    --apply_chat_template \
    ...
    --save_path $NAS/models/gemma-2-2b-ppo-saferlhf-2k-overweight \
    --save_steps -1 \
    --logging_steps 1 \
    --eval_steps 1 \
    ...
    --wandb_run_name gemma-2-2b-ppo-saferlhf-2k-overweight
