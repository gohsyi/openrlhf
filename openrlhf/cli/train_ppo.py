...
def train(args):
    ...
    eval_data = eval_data.select(range(min(args.max_samples_eval, len(eval_data))))
    ...
    if args.load_checkpoint and os.path.exists(os.path.join(args.ckpt_path, "_actor")):
        _, states = strategy.load_ckpt(actor.model, os.path.join(args.ckpt_path, "_actor"), args.load_checkpoint)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_samples_eval", type=int, default=1000000)
    ...
    parser.add_argument("--micro_eval_batch_size", type=int, default=8, help="batch size per GPU")
