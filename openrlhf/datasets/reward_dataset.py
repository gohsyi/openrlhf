...
class RewardDataset(Dataset):
    ...
    def __init__(
        ...
        # In case add extra spaces before eos token
        ...
        self.strategy.print("An example of processed chosen response:")
        self.strategy.print(self.chosens[0])
        self.strategy.print("An example of processed rejected response:")
        self.strategy.print(self.rejects[0])
